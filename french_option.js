...
const FrenchOption = () => {
  ...
  const handleRecipe = () => {
    navigation.navigate('MrngFrench');
  };
  const handleLunch = () => {
    navigation.navigate('LunchFrench');
  };
  const handleSnack = () => {
    navigation.navigate('SnackFrench');
  };
  const handleDessert = () => {
    navigation.navigate('DessFrench');
  };
