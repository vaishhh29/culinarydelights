...
const MexOption = () => {
  ...
  const handleRecipe = () => {
    navigation.navigate('MrngMexican');
  };
  const handleLunch = () => {
    navigation.navigate('LunchMex');
  };
  const handleSnack = () => {
    navigation.navigate('SnackMex');
  };
  const handleDessert = () => {
    navigation.navigate('DessertMex');
  };
